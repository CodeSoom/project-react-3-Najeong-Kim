    ...
    text: {
      ...
      choices: [
        ...
        },
        {
          id: 2,
          text:
            '굳이 특별한 비타민을 먹어야 하나요? 익숙함이 주는 편안함이 더 좋아요. 일상에서 즐거움을 얻고 싶어요~'
          ,
        },
      ],
    },
      ...
      choices: [
        {
          id: 1,
          text:
            '저는 무언가를 시청하고 관람하면서 시간을 보내거나 생각하는 시간을 갖는 것을 좋아해요.'
          ,
        },
        {
          id: 2,
    ...
    text: {
      ...
      choices: [
        ...
        },
        {
          id: 2,
          text:
            '저는 일정 시간을 투자해서 규칙적으로 비타민을 먹고 싶어요! 나의 열정을 쏟아낼 수 있는 비타민을 원해요.'
          ,
        },
      ],
    },
      ...
      choices: [
        {
          id: 1,
          text:
            '비타민을 먹으면 무언가 얻는 것이 있어야 하지 않겠어요!? 나를 대표하는 비타민을 갖거나 성취감을 얻고 싶어요!'
          ,
        },
        {
          id: 2,
          text:
            '저는 비타민으로 얻는 성과를 꼭 필요로 하진 않아요. 저의 감정을 다스려주는 비타민을 먹고 싶어요. 힐링이 필요해~'
          ,
        },
      ],
    },
      ...
      choices: [
        {
          id: 1,
          text:
            '저는 많은 사람들과 함께일 때보다 혼자일 때 에너지가 충전돼요. 저만의 시간을 갖고 비타민을 먹을 수 있으면 좋겠어요.'
          ,
        },
        {
          id: 2,
    ...
    text: {
      ...
      choices: [
        ...
        },
        {
          id: 2,
          text:
            '저는 행복을 위해서라면 얼마든 투자할 수 있어요! 제가 먹고 싶은 비타민을 먹을 수 있다면 가격은 중요하지 않아요.'
          ,
        },
      ],
    },
    ...
    text: {
      ...
      choices: [
        ...
        },
        {
          id: 2,
          text:
            '지금 하고 있는 일이 많아서 비타민을 먹는 방법까지 배우기는 어렵네요! 부담 없이 알고 있는 방법으로 비타민을 먹을래요~'
          ,
        },
      ],
    },
