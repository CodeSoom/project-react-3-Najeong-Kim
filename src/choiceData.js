      ...
      choices: [
        {
          id: 1,
          text:
            '저는 몸으로 표출하고 행동하는 외적인 활동을 좋아해요. 직접 경험하는 것들에서 큰 즐거움을 느껴요!'
          ,
        },
        {
          id: 2,
          text:
            '저는 보거나 들으면서 외부세계를 받아들이거나 내면을 성찰하는 시간을 갖는 것을 좋아해요.'
          ,
        },
      ],
    },
    ...
    text: {
      ...
      choices: [
        ...
        },
        {
          id: 2,
          text:
            '네? 먹는 방법을 배우라고요? 머리 쓰고 싶지 않은데.. 저는 먹던대로 먹을래요.'
          ,
        },
      ],
    },
